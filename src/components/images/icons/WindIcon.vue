<template>
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="d" x1="27.56" x2="38.27" y1="17.64" y2="36.19" gradientUnits="userSpaceOnUse">
    ...
    <path fill="none" stroke="url(#d)" stroke-dasharray="35 22" stroke-linecap="round" stroke-miterlimit="10"
    ...
    <path fill="none" stroke="url(#d)" stroke-dasharray="24 15" stroke-linecap="round" stroke-miterlimit="10"
