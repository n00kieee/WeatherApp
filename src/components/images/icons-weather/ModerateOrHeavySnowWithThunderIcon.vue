  ...
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64">
    <defs>
      ...
      <linearGradient id="a" x1="30.12" x2="31.88" y1="43.48" y2="46.52" gradientUnits="userSpaceOnUse">
        ...
        <animateTransform additive="sum" attributeName="gradientTransform" dur="9s" repeatCount="indefinite"
                          type="rotate" values="360 31 45; 0 31 45"/>
      </linearGradient>
      ...
      <linearGradient id="h" x1="26.74" x2="35.76" y1="37.88" y2="53.52" gradientUnits="userSpaceOnUse">
    ...
    <g>
      ...
      <path fill="none" stroke="url(#g)" stroke-linecap="round" stroke-miterlimit="10"
    ...
    <path fill="url(#h)" stroke="#f6a823" stroke-miterlimit="10" stroke-width=".5"
