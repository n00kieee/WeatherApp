<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
    <defs>
      <linearGradient id="z" x1="21.92" x2="38.52" y1="18.75" y2="47.52" gradientUnits="userSpaceOnUse">
    ...
    <path fill="url(#z)" stroke="#72b9d5" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5"
